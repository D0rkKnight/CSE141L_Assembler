...
Loop:                  //recalculate parity bits and xor each with original ones
    ...
    load r0 r2         //r2 = mem[31 + index counter] = b11:b5,p8
    ...
    load r0 r3         //r3 = mem[30 + index counter] = b4:b2,p4,b1,p2,p1,p0
    ...
    load r0 r2         //r2 = mem[30 + index counter] = b4:b2,p4,b1,p2,p1,p0
    ...
    load r0 r3         //r3 = mem[31 + index counter] = b11:b5,p8
...
Num_of_Errors:
    ...
    loadi r2 1         //r2 = 1
    add r1 r2          //r0 = 65
    load r0 r3         //r3 = mem[65] = p4rec xor p4
    ...
    loadi r2 2         //r2 = 2
    add r1 r2          //r0 = 66
    load r0 r3         //r3 = mem[66] = p2rec xor p2
    ...
    loadi r2 3         //r2 = 3
    add r1 r2          //r0 = 67
    load r0 r3         //r3 = mem[67] = p1rec xor p1
