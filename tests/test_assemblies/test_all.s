...
loadi r3 7 # Load immediate value 10 into r3
add r2 r3   # Add values in r2 and r3, store result in r0
...
mv r0 r3
lshift r3 1 # Left shift the value in r3 by 1 bit
rshift r3 1 # Right shift the value in r3 by 1 bit

mv r0 r3
parity r3 r6 # Check parity of value in r3, store result in r6
...
tag_3:       # Branch target
    loadi r1 7 # Load immediate value 7 into r1
    halt         # Stop execution